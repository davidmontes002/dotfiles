...
class NotificationDaemon(dbus.service.Object):
    ...
    def Notify(self, app_name, replaces_id, app_icon, summary, body, actions, hints, timeout):
        ...
        if replaces_id != 0:
            ...
            id = log['notifications'][0]['id'] + 1 if log['notifications'] else 1
        ...
        if "image-data" in hints:
            details["image"] = f"{cache_dir}/{id}.png"
    ...
    def GetServerInformation(self):
        return ("dotfiles-notification-daemon", "davidmontes002", "1.0", "1.2")
    ...
    def save_img_byte(self, px_args, save_path):
    ...
    def save_popup(self, notification):
        ...
        if len(current["popups"]) >= 3:
            oldest = current["popups"].pop()
            self.DismissPopup(oldest["id"])
